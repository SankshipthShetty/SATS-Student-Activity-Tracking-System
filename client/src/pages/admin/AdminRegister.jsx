...
const AdminRegister = () => {
  ...
  return (
    ...
    >
      <p className="gradient-text text-transparent text-5xl font-bold text-center animate-gradient mt-0 mb-8">
        REGISTER AS ADMIN
      </p>
      ...
      <div className="mt-8 flex gap-40">
        <Card className="w-96 h-98">
          <CardHeader>
            <CardTitle className="text-white text-center font-bold text-lg">
              ADMIN REGISTER
            </CardTitle>
          </CardHeader>
          <form onSubmit={handleSubmit} className="p-4">
            <div className="mb-4">
              <label htmlFor="branch" className="text-white font-bold">
                Branch
              </label>
              <input
                type="text"
            ...
            <div className="mb-4">
              <label htmlFor="fname" className="text-white  font-bold">
                First Name
              </label>
              <input
                type="text"
            ...
            <div className="mb-4">
              <label htmlFor="lname" className="text-white  font-bold">
                Last Name
              </label>
              <input
                type="text"
            ...
            <div className="mb-4">
              <label htmlFor="faculty_no" className="text-white  font-bold">
                Faculty Number
              </label>
              <input
                type="text"
            ...
            <Button
              type="submit"
              className="ml-32 bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded-md mt-4"
            >
              Submit
            </Button>
